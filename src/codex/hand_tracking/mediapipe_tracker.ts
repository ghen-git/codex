...
export class MediapipeTracker {
    ...
    handEventHandler: (data: Hands, zImproved: boolean) => void;
    landmarker: HandLandmarker;
    lastFrame: number;
    video?: HTMLVideoElement;
    window: Window;
    running: boolean;
    lastHandsFromZCamera?: Hands;
    receivedZEnhancement: boolean;
    blockUntilZEnhanced: boolean;

    constructor(handEventHandler: (data: Hands, zImproved: boolean) => void, landmarker: HandLandmarker, window: Window, blockUntilZEnhanced: boolean/*, nWorkers: number*/) {
    ...
    public static async create(handEventHandler: (data: Hands, zImproved: boolean) => void, window: Window, blockUntilZEnhanced: boolean = false) {
    ...
    public updateZCameraHands(hands: Hands) {
