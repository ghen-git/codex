...
export function touchingEachOthersTips(hand1: Hand, hand2: Hand, maxTouchingDistance: number = 0.6) {
...
export function pinchingAny(hand: Hand, maxPinchDistance: number =  0.6) {
...
export function pinching(hand: Hand, maxPinchDistance: number =  0.6) {
    return touchingTips(hand.thumb, hand.index, maxPinchDistance);
}

export function touchingTips(finger1: Finger, finger2: Finger, maxTouchingDistance: number =  0.6) {
